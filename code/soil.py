...
class Plant(pygame.sprite.Sprite):
	def __init__(self, plant_type, groups, soil, check_watered):
		...
		self.frames = import_folder(os.path.join('graphics', 'fruit', plant_type))
		self.soil = soil
...
class SoilLayer:
	def __init__(self, all_sprites, collision_sprites):
		...
		# graphics
		self.soil_surfs = import_folder_dict(os.path.join('graphics', 'soil'))
		self.water_surfs = import_folder(os.path.join('graphics', 'soil_water'))

		self.create_soil_grid()
		self.create_hit_rects()

		# sounds
		self.hoe_sound = pygame.mixer.Sound(os.path.join('audio', 'hoe.wav'))
		self.hoe_sound.set_volume(0.1)

		self.plant_sound = pygame.mixer.Sound(os.path.join('audio', 'plant.wav'))
